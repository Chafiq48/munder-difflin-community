...
- **macOS, Windows, or Linux** — signed/notarized macOS builds, plus Windows and
  Linux builds, ship from the [releases page](https://github.com/Chafiq48/munder-difflin-community/releases/latest).
...
- **A rewrite nobody asked for.** Large architectural changes need an issue or a
  [discussion](https://github.com/Chafiq48/munder-difflin-community/discussions) with
