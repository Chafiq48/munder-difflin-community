...
# Munder Difflin Community v0.4.7
...
<!-- drop -->
<div class="drop">
  <p class="eyebrow">Munder Difflin Community 0.4.7</p>
...
| Build | File |
|---|---|
| Universal (Apple Silicon + Intel) | [`Munder-Difflin-0.4.7-mac-universal.dmg`](https://github.com/Chafiq48/munder-difflin-community/releases/latest/download/Munder-Difflin-0.4.7-mac-universal.dmg) |

### 🪟 Windows
| Build | File |
|---|---|
| Installer (x64), *recommended* | [`Munder-Difflin-0.4.7-win-x64-setup.exe`](https://github.com/Chafiq48/munder-difflin-community/releases/latest/download/Munder-Difflin-0.4.7-win-x64-setup.exe) |
| Portable (x64, no install) | [`Munder-Difflin-0.4.7-win-x64-portable.exe`](https://github.com/Chafiq48/munder-difflin-community/releases/latest/download/Munder-Difflin-0.4.7-win-x64-portable.exe) |

### 🐧 Linux
| Build | File |
|---|---|
| AppImage (x86_64) | [`Munder-Difflin-0.4.7-linux-x86_64.AppImage`](https://github.com/Chafiq48/munder-difflin-community/releases/latest/download/Munder-Difflin-0.4.7-linux-x86_64.AppImage) |

### 📦 Source
[Source code (zip)](https://github.com/Chafiq48/munder-difflin-community/archive/refs/tags/v0.4.7.zip) ·
[Source code (tar.gz)](https://github.com/Chafiq48/munder-difflin-community/archive/refs/tags/v0.4.7.tar.gz)
